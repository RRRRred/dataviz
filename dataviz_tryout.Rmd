...
```{r}
texas <- read.csv("C:/Users/Eigenaar/Documents/R cursus EUR/git_workspace/dataviz/dataset cancer Texas.csv", header = TRUE, sep = ",")
str(texas)
head(texas)
texas2 <- read_csv("C:/Users/Eigenaar/Documents/R cursus EUR/git_workspace/dataviz/dataset cancer Texas.csv")
head(texas2)
```
